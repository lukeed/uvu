...
With this, `uvu` will register that the `"this will fail"` test failed.<br>You will only be missing the detailed insights (aka, pretty diff'ing) that the included [`Assertion`](#TODO) errors provide.
